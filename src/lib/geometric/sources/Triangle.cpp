...
//! [0]
Triangle::Triangle(int id, Vertex* v0, Vertex* v1, Vertex* v2, Constant::ObjectStatus status){
    this->idp =  id;
...
void Triangle::setStatus(Constant::ObjectStatus status){
    this->statusp = status;
}

Constant::ObjectStatus Triangle::getStatus(){
    return this->statusp;
}
