...
//        double orient=Util::orientation(T->vertex(0), T->vertex(1), T->vertex(2));
//        if(orient < 0.000001) qDebug("Triangle %d has negative orientation of its vertexes", orient);
//        int share = 0;
//        for(int i=0; i<3; i++){
...
//            }
//            if(share != 2) qDebug("Triangles %d and %d are not valid neighbours", T->id(), N->id());
//            share = 0;
//            }
//        }
//    }
