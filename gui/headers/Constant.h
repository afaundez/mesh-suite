...
namespace Constant{
    ...
    enum TriangleSelection{ SMALLEST_INTERNAL_ANGLE, SMALLEST_EDGE, SMALLEST_EDGE_BORDER_TRIANGLE_FIRST};
    enum NewPoint{ LEPP_BISECTION, RUPPERT, LEPP_CENTROID, LEPP_CIRCUMCENTER, UNGOR};
